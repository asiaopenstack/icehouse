...
read -p "Enter the floating network size (eg. 8): " floating_size

# get nova
apt-get -y install nova-api nova-cert nova-common nova-compute nova-compute-kvm nova-doc nova-network nova-objectstore nova-scheduler nova-vncproxy nova-volume python-nova python-novaclient nova-consoleauth novnc
